    ...
    <div id="themhopdong">
                <form action="" enctype="multipart/form-data" @submit.prevent="postHopDong()">
                    <table class="table">
                        ...
                        <tr>
                            <td><label for="vaitro">Nhập vi tri</label></td>
                            <td>
                        ...
                        <tr>
                            <td><label for="username">Nhập username</label></td>
                            <td><input type="text" v-model="hopdong.username" id="username"></td>
                        </tr>
                        <tr>
                            <td><label for="password">Nhập password</label></td>
                            <td><input type="password" v-model="hopdong.password" id="password"></td>
                        </tr>
                        <tr>
                            <td><label for="password_confirmation">Xác nhận password</label></td>
                            <td><input type="password" v-model="hopdong.password_confirmation" id="password_confirmation"></td>
                        </tr>
                        <tr>
...
export default {
    ...
    methods:{
        ...
        postHopDong(){
            ...
            console.log(this.hopdong.idphucap);
            const config = {
                    headers: {
            ...
            formData.append('username', this.hopdong.username);
            formData.append('password', this.hopdong.password);
            formData.append('password_confirmation', this.hopdong.password_confirmation);
            formData.append('luong', this.hopdong.luong);
            formData.append('idphucap[]', ['1', '2']);
